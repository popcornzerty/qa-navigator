# Spécification d'origine — Phase 1

Cahier des charges initial du frontend, conservé pour mémoire. Il décrit une première
phase sur données simulées ; l'outil a depuis dépassé ce périmètre (moteur réel, import
des tests existants, exécution, état des lieux). Le README à la racine décrit l'état actuel.
